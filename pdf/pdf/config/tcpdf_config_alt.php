 ...
 */
define ('PDF_HEADER_LOGO', 'logoAsociacion.jpg');
 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'Asociación Pataz');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'Asociación Pataz');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'SISTEMA DE GESTIÓN DE SEGUIMIENTO DE PRODUCCIÓN AGRÍCOLA');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "PARA LA INVESTIGACIÓN AGRARIA (SPAIAP)\nwww.SPAIAP.org\ncontacto@spaiap.org");
