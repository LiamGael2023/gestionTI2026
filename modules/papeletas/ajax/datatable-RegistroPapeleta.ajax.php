...
class tablaPapeleta
{
    ...
    public function mostrartablaPapeleta()
    {
        ...
        foreach ($papeletas as $key => $papeleta) {
            ...
            $concepto = utf8_encode($papeleta["Id_Trabajador_Concepto_APP"]);
            $motivo   = utf8_encode($papeleta["Id_Trabajador_Motivo_APP"]);
            $lugar    = utf8_encode($papeleta["Id_Trabajador_Lugar_APP"]);
            ...
            $JefeInmediato = '<td><h6>' . utf8_encode($papeleta["JefeInmediato_apellidos"]) . '<br>' . utf8_encode($papeleta["JefeInmediato_nombres"]) . '</h6></td>';
