...
class ConformidadModel
{
	...
	public function obtenerPorTecnologia($idCatalogoTecnologico, $anio = null)
	{
		...
		$sql = "
			...
			FROM adquisiciones.Conformidad
	...
	{
		$sqlCheck = "SELECT Id FROM adquisiciones.Conformidad WHERE IdCatalogoTecnologico = ? AND Anio = ?";
	...
	{
		$sql = "DELETE FROM adquisiciones.Conformidad WHERE Id = ?";
