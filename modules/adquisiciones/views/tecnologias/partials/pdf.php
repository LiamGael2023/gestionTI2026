 ...
 *   modules/adquisiciones/views/tecnologias/partials/pdf.php?tipo=orden&id=123
 *   modules/adquisiciones/views/tecnologias/partials/pdf.php?tipo=verificacion&id=123
 */
...
if (headers_sent($archivoOrigen, $lineaOrigen)) {
	error_log(sprintf('[adquisiciones/views/tecnologias/partials/pdf.php] Headers ya enviados en %s:%d', $archivoOrigen, $lineaOrigen));
	http_response_code(500);
	exit;
}
