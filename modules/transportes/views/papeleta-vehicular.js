$(document).ready(function () {
  ...
  if ($(".tablaPapeletasVehiculares").length) {
    $(".tablaPapeletasVehiculares").DataTable().destroy();
    ...
    var tablaAdmin = $(".tablaPapeletasVehiculares").DataTable({
      ajax: {
        url: "modules/transportes/ajax/datatable-PapeletasVehiculares.ajax.php",
        type: "POST",
        data: function (d) {
