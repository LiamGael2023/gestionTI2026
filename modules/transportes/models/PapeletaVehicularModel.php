...
class ModeloPapeletaVehicular
{
    ...
    static public function mdlRegistrarBitacora($datos)
    {
        ...
        $sql = "EXEC BD_PERSONAL.Transportes.SP_InsertarBitacora ?, ?";
    ...
    static public function MdlMostrarPapeletasVehiculares(
        ...
        try {
            ...
            // ============================================
            $sql = "EXEC [BD_PERSONAL].[Transportes].[VW_Papeleta_Vehicular_Sede] ?, ?, ?, ?, ?, ?";
            $params = array(
                $id_establecimiento,
                $start,
                $length,
    ...
    static public function MdlMostrarSedesSalidaVehicular()
    {
        ...
        $sql = "select id_sede as id, sede_nombre as sede, sede_abrev as abreviatura from [BD_PERSONAL].[Transportes].[tbl_sede_salida_vehicular]";
    ...
    static public function MdlMostrarPlacaVehicular()
    {
        ...
        $sql = "select Id_Vehiculo as id, placa as placaseleccionada from [BD_PERSONAL].[Transportes].[tbl_Vehiculo]  ";
        $stmt = sqlsrv_query($conn, $sql);
