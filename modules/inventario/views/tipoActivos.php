  ...
  <div class="page-wrapper">
    <div class="container-xl">
      ...
      <div class="card mb-4"
        ...
        <!-- ── TOOLBAR DESKTOP (md+) ──────────── -->
        <div class="d-none d-md-flex align-items-center gap-2 flex-wrap px-3 py-2 border-bottom"
             id="dtToolbar">
          ...
          <div class="table-responsive">
            <table id="tablaActivos"
              ...
              <?php foreach ($activos as $v):
                ...
                if ($esPer)     $badge = '<span class="badge bg-green-lt text-green"><i class="ti ti-mouse me-1"></i>Periférico</span>';
                elseif ($esCom) $badge = '<span class="badge bg-blue-lt text-blue"><i class="ti ti-cpu me-1"></i>Compuesto</span>';
                else            $badge = '<span class="badge bg-azure-lt text-azure"><i class="ti ti-package me-1"></i>Simple</span>';
              ?>
              <tr>
                <td>
                  <div class="d-flex align-items-center gap-2">
                ...
                <td class="text-end">
                  <div class="d-flex justify-content-end gap-1">
                    ...
                    <button class="btn btn-sm btn-ghost-danger btnEliminarActivo"
                            data-id="<?= $v['idTipoActivo'] ?>"
                            data-descripcion="<?= $desc ?>" title="Eliminar">
          ...
          <div class="row g-3">
            ...
            <div class="col-12">
              ...
              <input type="text" class="form-control" id="nuevaDescripcion"
                     name="nuevaDescripcion" maxlength="150"
                     placeholder="Describa el tipo de activo..."
            ...
            <div class="col-md-5">
              ...
              <div class="card card-sm text-center">
                <div class="card-body py-3">
                  <div class="avatar avatar-xl bg-primary-lt text-primary mb-2"
                       id="previewIcon">
            ...
            <div class="col-12">
              ...
              <div class="row g-2">
                <div class="col-12 col-md-4">
                  <label class="card card-sm mb-0" style="cursor:pointer"
                         for="nuevoEsCompuesto">
                    <div class="card-body d-flex align-items-center
                      ...
                      <div class="form-check form-switch m-0">
                        <input class="form-check-input" type="checkbox"
                               id="nuevoEsCompuesto" name="nuevoEsCompuesto" value="1">
                      </div>
                    </div>
                  </label>
                </div>
                <div class="col-12 col-md-4">
                  <label class="card card-sm mb-0" style="cursor:pointer"
                    ...
                    <div class="card-body d-flex align-items-center
                      ...
                      <div class="form-check form-switch m-0">
                        <input class="form-check-input" type="checkbox"
                               id="nuevoEsComponente" name="nuevoEsComponente" value="1">
                      </div>
                    </div>
                  </label>
                </div>
                <div class="col-12 col-md-4">
                  <label class="card card-sm mb-0" style="cursor:pointer"
                    ...
                    <div class="card-body d-flex align-items-center
                      ...
                      <div class="form-check form-switch m-0">
                        <input class="form-check-input" type="checkbox"
                               id="nuevoEsPeriferico" name="nuevoEsPeriferico" value="1">
                      </div>
                    </div>
                  </label>
                </div>
          ...
          <div class="row g-3">
            ...
            <div class="col-12">
              ...
              <input type="text" class="form-control" id="editarDescripcion"
                     name="editarDescripcion" maxlength="150"
                     style="text-transform:uppercase" required>
            </div>
