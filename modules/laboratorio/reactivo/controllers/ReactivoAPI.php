...
try {
    ...
    $urlSubmodulo   = '?module=laboratorio&action=reactivo';
    $permActionMap  = [
        'guardar'          => 'crear',
        'actualizar'       => 'editar',
        'eliminar'         => 'eliminar',
        'reactivar'        => 'editar',
        'registrar_ingreso'=> 'crear',
        'registrar_salida' => 'editar',
        'editar_ingreso'   => 'editar',
        'editar_salida'    => 'editar',
        'eliminar_salida'  => 'eliminar',
        'guardar_unidad'   => 'crear',
        'eliminar_unidad'  => 'eliminar',
    ];
