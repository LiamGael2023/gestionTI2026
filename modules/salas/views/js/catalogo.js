...
function ajax(action, data, method) {
  return $.ajax({ url: AJAX + '?action=' + action, method: method || 'POST', data: data, dataType: 'json' });
}
...
var Alerta = {
  exito: function(msg) { return Swal.fire({ icon:'success', title:'Éxito', text:msg, timer:2500, showConfirmButton:false }); },
  error: function(msg) { return Swal.fire({ icon:'error', title:'Error', text:msg }); },
  confirmarPeligro: function(msg, cb) { return Swal.fire({
