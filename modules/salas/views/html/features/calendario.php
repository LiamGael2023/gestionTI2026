...
<div id="salas-root">
  ...
  <div id="salas-topbar">
    ...
    <div class="salas-filters">
      ...
      <button type="button" id="btn-ver-dashboard" onclick="irDashboardConFade()">
        <i class="ti ti-chart-line me-1"></i>Ver Dashboard
      </button>
    </div>
    <span class="d-none d-lg-inline text-secondary" style="font-size:.72rem;white-space:nowrap;opacity:.6;">
  ...
  <div id="salas-body">
    ...
    <!-- Calendario -->
    <div id="salas-cal-panel" class="view-fade">
...
<!-- SCRIPTS (CDN) + Variables PHP → JS + archivos JS organizados por capas -->
<script src="https://code.jquery.com/jquery-3.7.1.min.js"></script>
<script src="https://cdn.datatables.net/1.13.6/js/jquery.dataTables.min.js"></script>
<script src="https://cdn.datatables.net/1.13.6/js/dataTables.bootstrap5.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/fullcalendar@6.1.11/index.global.min.js"></script>
...
<!-- Shared (siempre se cargan, código reutilizable) -->
<script src="<?= BASE_URL ?>/modules/salas/views/js/shared/api.js"></script>
<script src="<?= BASE_URL ?>/modules/salas/views/js/shared/debug.js"></script>
...
<script src="<?= BASE_URL ?>/modules/salas/views/js/shared/mobile-responsive.js"></script>

<!-- Features (características compartidas) -->
<script src="<?= BASE_URL ?>/modules/salas/views/js/features/calendario.js"></script>

<!-- Reservas (crear nueva solicitud) - para cualquier usuario -->
<script src="<?= BASE_URL ?>/modules/salas/views/js/roles/usuario/reservas.js"></script>
