...
<!-- Historial para Autorizadores -->
<script src="<?= BASE_URL ?>/modules/salas/views/js/roles/autorizador/historial.js?v=<?= filemtime(__DIR__ . '/../../../js/roles/autorizador/historial.js') ?>"></script>
