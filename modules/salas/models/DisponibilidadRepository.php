 ...
 * Verificación de disponibilidad de salas y eventos para FullCalendar.
 *
 * Principio SOLID aplicado: SRP — solo resuelve disponibilidad y eventos de calendario.
...
{
    /**
     * Verifica si una sala está libre en el rango fecha/hora indicado.
     *
     * @param int    $excluir_id  ID de reserva a excluir del chequeo (uso en edición).
     */
    public function verificarDisponibilidad(
        ...
        if (strtotime($inicio_dt) <= time()) {
            return [
                'disponible' => false,
                'mensaje'    => 'No se puede reservar en una fecha u hora que ya pasó.',
            ];
        }
        ...
        return (int) ($row['total'] ?? 0) > 0
            ? ['disponible' => false, 'mensaje' => 'La sala no está disponible en ese horario.']
            : ['disponible' => true,  'mensaje' => 'La sala está disponible.'];
    }

    /**
     * Eventos de una sala específica para el mini-calendario de la solicitud.
     */
