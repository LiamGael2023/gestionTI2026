...
require_once __DIR__ . '/../repositories/SedesRepository.php';
require_once __DIR__ . '/../repositories/SalasRepository.php';
require_once __DIR__ . '/../repositories/EquiposRepository.php';
require_once __DIR__ . '/../repositories/DisponibilidadRepository.php';
require_once __DIR__ . '/../repositories/ReservasRepository.php';
require_once __DIR__ . '/../repositories/AutorizacionRepository.php';
require_once __DIR__ . '/../repositories/EstadisticasRepository.php';
...
class SalasModel extends BaseModel
{
    ...
    // =========================================================================
    // DASHBOARD - delega a DashboardRepository
    // =========================================================================

    public function obtenerDocumentosConGerenciaValida(): array                 { return $this->dashboardRepo->obtenerDocumentosConGerenciaValida(); }
    public function getUtilizacionSalas(array $documentos_validos = []): array                                 { return $this->dashboardRepo->getUtilizacionSalas($documentos_validos); }
    public function getEstadoSolicitudes(array $documentos_validos = []): array                               { return $this->dashboardRepo->getEstadoSolicitudes($documentos_validos); }
    public function getTopEquiposPorSala(array $documentos_validos = []): array                               { return $this->dashboardRepo->getTopEquiposPorSala($documentos_validos); }
    public function getTendenciasTemporales(array $documentos_validos = []): array                            { return $this->dashboardRepo->getTendenciasTemporales($documentos_validos); }
    public function getAnalisisPorGerencia(array $documentos_validos = []): array                             { return $this->dashboardRepo->getAnalisisPorGerencia($documentos_validos); }
    public function getTiempoAprobacionPorGerencia(array $documentos_validos = []): array                    { return $this->dashboardRepo->getTiempoAprobacionPorGerencia($documentos_validos); }
    public function obtenerDatosDelAPIPersonal(array $documentos): array       { return $this->dashboardRepo->obtenerDatosDelAPIPersonal($documentos); }
}