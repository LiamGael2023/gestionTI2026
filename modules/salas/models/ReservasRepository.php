 ...
 *
 * Principio SOLID aplicado: SRP — solo gestiona el ciclo de vida
...
class ReservasRepository extends BaseModel
{
    ...
    /**
     * Reservas del solicitante ordenadas por fecha de creación descendente.
     */
    ...
    public function cancelarReserva(int $id_reserva, int $id_usuario): array
    {
        ...
        // Obtener datos para la notificación antes de cancelar
        $info = $this->fetchOne(
            "SELECT r.motivo,
                    CONVERT(varchar(10), r.fecha, 120) AS fecha,
                    CONVERT(varchar(5), r.hora_inicio, 108) AS hora_inicio,
