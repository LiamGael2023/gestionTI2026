...
require_once __DIR__ . "/../controllers/PlanillaController.php";
...
class AjaxPlanilla
{
    ...
    {
        $respuesta = PlanillaController::ctrConsultarAniosBoletas();
    ...
    static public function ajaxListarBoletasPorAnio()
    {
        ...
        $respuesta = PlanillaController::ctrListarBoletasPorAnio($anio);
    ...
    static public function ajaxActualizarDescargadoBoleta()
    {
        ...
        $respuesta = PlanillaController::ctrActualizarDescargadoBoleta(
            $mes,
            $anio,
            $planilla_auxiliar
        );
    ...
    static public function ajaxConsultarAniosBoletasPorTrabajador()
    {
        ...
        $respuesta = PlanillaController::ctrConsultarAniosBoletasPorTrabajador($id_trabajador);
        echo json_encode($respuesta);
    }
    ...
    static public function ajaxListarBoletasPorAnioPorTrabajador()
    {
        ...
        $respuesta = PlanillaController::ctrListarBoletasPorAnioPorTrabajador($anio, $id_trabajador);
