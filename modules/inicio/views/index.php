                          ...
                          <div class="row g-3">
                              ...
                              <div class="col-sm-6">
                                  <div class="d-flex align-items-start gap-2">
                                      <img src="modules/inicio/img/documento.svg" width="20" height="20" alt="">
                                      <div>
                              ...
                              <div class="col-sm-6">
                                  <div class="d-flex align-items-start gap-2">
                                      <img src="modules/inicio/img/fecha-nacimiento.svg" width="20" height="20" alt="">
                                      <div>
                              ...
                              <div class="col-sm-6">
                                  <div class="d-flex align-items-start gap-2">
                                      <img src="modules/inicio/img/correo.svg" width="20" height="20" alt="">
                                      <div>
                              ...
                              <div class="col-sm-6">
                                  <div class="d-flex align-items-start gap-2">
                                      <img src="modules/inicio/img/celular.svg" width="20" height="20" alt="">
                                      <div>
                              ...
                              <div class="col-sm-6">
                                  <div class="d-flex align-items-start gap-2">
                                      <img src="modules/inicio/img/tipo-trabajador.svg" width="20" height="20" alt="">
                                      <div>
                              ...
                              <div class="col-sm-6">
                                  <div class="d-flex align-items-start gap-2">
                                      <img src="modules/inicio/img/jefe_inmediato.svg" width="20" height="20" alt="">
                                      <div>
              ...
              success: function(res) {
                ...
                <tr>
                  ...
                  $(document).on("click", ".badge-descargar", function() {
                      ...
                      $.post("modules/inicio/ajax/planilla.ajax.php", {
        ...
        <div class="modal-content shadow-lg border-0 rounded-4 overflow-hidden">
            ...
            <div class="modal-body text-center p-3">
                <p class="mb-2 fw-semibold">
                    ¡Hola <?php echo (isset($_SESSION["Trab_Nombres"]) ? $_SESSION["Trab_Nombres"] : ''); ?>! 👋
                </p>
