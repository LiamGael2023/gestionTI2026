        ...
        <div class="modal-content">
            ...
            <form id="formEvidencias" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success">Guardar Evidencias</button>
                </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#formEvidencias").off('submit').on("submit", function(e) {
            e.preventDefault();
            let formData = new FormData(this);
            formData.append("accion", "subir_evidencias");

            const idPapeleta = $("#id_papeleta_modal").val();
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status === "success") {
                        ...
                        cargarEvidencias(idPapeleta); // recargar galería
                        $("#evidencia").val('');
                        $("#previewEvidencias").empty();
                    } else {
                ...
                error: function() {
                    ...
                    $("#spinnerCarga").hide();
                    Swal.fire('Error', 'Ocurrió un error al subir las evidencias.', 'error');
                }
            });
        });
